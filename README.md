...
- Créer une interface interactive avec HTML, CSS et JavaScript;
...
- 🎨 Mise en couleur des réponses après validation;

- 🟢 Bonne réponse en vert;

- 🔴 Mauvaise réponse choisie en rouge;

- 🚫 Blocage de la validation si toutes les questions ne sont pas répondues;
...
- JavaScript — Logique des quiz et interactions.